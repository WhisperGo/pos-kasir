    ...
    <div class="sidebar-body pt-0 data-scrollbar">
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item static-item">
            <a class="nav-link static-item disabled" tabindex="-1">
              <span class="default-icon">Data Barang</span>
              <!-- <span class="mini-icon">-</span> -->
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link <?php if($uri->getSegment(1) == "buku"){echo "active";}?>" href="<?=base_url('buku')?>"><i class="fa-solid fa-books"></i><span class="item-name">Data Produk</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link <?php if($uri->getSegment(1) == "peminjaman" && $uri->getSegment(2) !== "menu_laporan"){echo "active";}?>" href="<?=base_url('peminjaman')?>"><i class="fa-duotone fa-arrow-right-arrow-left"></i><span class="item-name">Data Penjualan</span>
            </a>
          </li>
